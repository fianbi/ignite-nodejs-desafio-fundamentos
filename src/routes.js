...
export const routes = [
    {
        ...
        handler: (req, res) => {
            ...
            if(!title || !description) return res.writeHead(400)
    ...
    },
    {
        ...
        handler: (req, res) => {
            ...
            if(!title || !description) return res.writeHead(400)
                .end(JSON.stringify({ error: 'Title or description are required' }))
    ...
    },
    {
        ...
        handler: (req, res) => {
            ...
            if(!task) return res.writeHead(404).end({ error: 'Task not found' })
